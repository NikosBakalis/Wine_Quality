    ...
    if question == "A":
        ...
        while choice != "Leave":
            ...
            if choice == "Average":
                ...
                linker.csv_add_column("C:\\Users\\Nikolas\\PycharmProjects\\Wine_Quality\\Input\\winequality-red-delete.csv", 8, average_number, "C:\\Users\\Nikolas\\PycharmProjects\\Wine_Quality\\Input\\winequality-red-add.csv")
